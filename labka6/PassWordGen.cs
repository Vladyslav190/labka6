...
namespace Lab06
{
    class PassWordGen
    {
        ...
        const int myIterations = 1000; // поки не використовую (ця кількість ітерацій
        //впливає на ключ, який буде сформовано з пароля)
        byte[] salt0 = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 }; // не менше 8 байт (цей масив
        //впливає на ключ, який буде сформовано з пароля)
        byte[] _result;
        ...
        {
            // PBKDF2 (англ. Password-Based Key Derivation Function) — стандарт створення
            //ключа на основі пароля.
            Rfc2898DeriveBytes k0 = new Rfc2898DeriveBytes(passWord, salt0); 
            //те саме, що і з myIterations = 1000
